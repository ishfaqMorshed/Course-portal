...
export default function AppShell({ active, onNav, title, subtitle, onBack, backLabel, onLogout, children }: AppShellProps) {
        ...
        {drawer && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-[260px] bg-white shadow-float flex flex-col">
              ...
              <Sidebar active={active} onNav={(id) => { setDrawer(false); onNav(id); }} />
            </div>
          </div>
        )}
        {/* main column */}
